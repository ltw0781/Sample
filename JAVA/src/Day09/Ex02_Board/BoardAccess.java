...
//	boardList[2] = new Board("제목02", "작성자03", "내용03");
//	boardList[3] = new Board("제목03", "작성자04", "내용04");
//	boardList[4] = new Board("제목04", "작성자05", "내용05");
	...
	public Board create(Board board) {
		...
		// 게시글 등록
		int boardNo = ++count;						// --> 등록된 게시글의 갯수 정수형 타입인 count를 
