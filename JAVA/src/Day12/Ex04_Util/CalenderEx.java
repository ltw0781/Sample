...
public class CalenderEx {
	...
	public static void main(String[] args) {
		...
		// * new Calender() 대신, setInstence() 메소드로 객체를 사용한다.
		...
		printCalender("자바 마지막 수업일(년/월/일", test);
		
		test.set(2024, Calendar.FEBRUARY, 27, 18, 30, 0);
		printCalender("자바 마지막 수업일(년~초", test);
		...
		System.out.println("1970년 1월 1일 0시 0분 0초 0ms~오늘까지 일수 : " + nowD);
		System.out.println("1970년 1월 1일 0시 0분 0초 0ms~오늘까지 일수 : " + lastD);
		
		// 내가 태어난 지 몇 일
		Calendar birth = Calendar.getInstance();
		birth.set(1993, Calendar.OCTOBER, 14, 0, 0, 0);
