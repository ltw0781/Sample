...
public class VectorEx {
	...
	public static void main(String[] args) {
		...
		Vector<Integer> list = new Vector<Integer>();	// 기본생성 : 기본용량10, 2배씩 증분
		//요소 추가
		list.add(1);
		list.add(2);
		list.add(3);
		...
		// 해당 리스트 컬렉션으로 부터 Iterator 객체를 가져와서 반복할 수 있다.
		
		// iterator()
		// : 각 리스트 컬렉션 객체로 부터 Iterator 객체를 반환하는 메소드
		// Iterator
		// - hasNext()					: 다음 요소의 존재여부
		// - next()						: 다음 요소를 반환
		...
		// 삭제
		// - 삭재할 때, 삭제한 위치 뒤의 index 가 앞으로 한 칸 씩 당겨진다.
		// 0		1		2		3		4
